			...
			<div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            ...
                            $result = mysqli_query($connection,"SELECT count(*) as nb FROM review_table");
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            ...
                            $result = mysqli_query($connection,"SELECT count(*) as nb FROM orderinfo");
                            $row = mysqli_fetch_assoc($result);
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            ...
                            $result = mysqli_query($connection,"SELECT SUM(order_total) as nb FROM orderinfo");
                            $row = mysqli_fetch_assoc($result);
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            ...
                            $result = mysqli_query($connection,"SELECT count(distinct customer_name) as nb FROM orderinfo;");
                            $row = mysqli_fetch_assoc($result);
										...
										<div class="card-content table-responsive">
											<table class="table table-hover">
												...
												<tbody>
													...
													<?php
														$result = mysqli_query($connection,"SELECT * FROM currency"); 
