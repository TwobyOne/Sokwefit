									...
									<div class="card">
										...
										<div class="card-content table-responsive">
											<table class="table table-hover">
												...
												<?php
														$id = $_GET["id"];
														$result = mysqli_query($connection,"SELECT order_item_id, order_items.order_id, item_name, item_quantity, toppings_price, item_total, order_currency FROM orderinfo , order_items WHERE orderinfo.order_id=$id and order_items.order_id=$id;"); 
